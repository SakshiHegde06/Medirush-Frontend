...
export default function PatientAuth() {
  ...
  const handleVerifyOtp = () => {
    if (enteredOtp === generatedOtp) {
      login("patient", { id: "P_NEW", name: form.name, email: form.email, phone: form.phone })
      navigate("/patient/dashboard")
    } else {
          ...
          <div className="glass-card" style={{ padding: 40, maxWidth: 400, width: "90%", textAlign: "center", border: "1px solid rgba(0,201,167,0.3)", animation: "fadeInUp 0.4s ease forwards" }}>
            ...
            <input
              ...
              style={{
                ...
                border: `1px solid ${otpError ? "var(--coral)" : "var(--border)"}`,
            ...
            <button className="btn-primary" onClick={handleVerifyOtp} disabled={enteredOtp.length !== 6}
